  ...
  const projects = [
    {
      ...
      category: "Web Apps",
      description:
        "A comprehensive project management application with real-time collaboration, task tracking, and team analytics.",
      image: "/api/placeholder/400/300",
      technologies: ["React", "Node.js", "PostgreSQL", "Socket.io", "AWS"],
      liveUrl: "https://taskflow-demo.com",
      githubUrl: "https://github.com/nyhenry/taskflow-pro",
      features: [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/nyhenry/shopsmart",
      features: [
        "Payment processing",
        "Inventory tracking",
        "Admin dashboard",
